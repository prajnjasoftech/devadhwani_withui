<template>
    <AdminLayout>
        <div class="page-header">
            <h1 class="page-title">Edit Pooja</h1>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="d-flex gap-3 mt-4">
                        <button type="submit" class="btn btn-primary" :disabled="processing">
                            ...
                            <span v-else>
                                <i class="bi bi-check-circle"></i> Update Pooja
                            </span>
                        </button>
...
const form = reactive({
    pooja_name: props.pooja.pooja_name || '',
    period: props.pooja.period || '',
    amount: props.pooja.amount || '',
    details: props.pooja.details || '',
    devotees_required: props.pooja.devotees_required || false,
    next_pooja_perform_date: props.pooja.next_pooja_perform_date || '',
    deity_id: props.pooja.deity_id || ''
});
...
const submit = () => {
    ...
    router.put(`/poojas/${props.pooja.id}`, form, {
        onSuccess: () => {
