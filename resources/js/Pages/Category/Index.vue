    ...
    <AdminLayout>
                            ...
                            <tr v-for="(category, index) in categories.data" :key="category.id">
                                ...
                                <td>
                                    <div class="action-btns">
                                        <Link :href="`/categories/${category.id}/edit`" class="btn btn-sm btn-outline">
                                            <i class="bi bi-pencil"></i>
                                        </Link>
                                        <button @click="confirmDelete(category)" class="btn btn-sm btn-outline text-danger">
        ...
        <div class="modal-overlay" v-if="showDeleteModal" @click="showDeleteModal = false">
            <div class="modal-content" @click.stop>
                ...
                <p class="text-warning" v-if="categoryToDelete?.items_count > 0">
                    <i class="bi bi-exclamation-triangle"></i> This category has {{ categoryToDelete.items_count }} item(s) associated.
                </p>
